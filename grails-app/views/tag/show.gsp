...
<body>
    <div class="span8">
        <h1 class="header"><g:fieldValue bean="${tagInstance}" field="title"/></h1>
        <dl class="dl-horizontal">
            ...
            <dd>
                <g:link controller="tag" action="show" id="${tagInstance?.parent?.id}">${tagInstance?.parent?.encodeAsHTML()}</g:link>
            </dd>
            </g:if>
                ...
                <g:form>
                    <fieldset class="buttons">
                        ...
                        <g:link class="tms-btn tms-warning"
                                action="edit"
                                id="${tagInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
