...
<div class="span8">
    ...
    <table class="table">
        <thead>
        <tr>
            <g:sortableColumn property="applicant" title="${message(code: 'application.applicant', default: 'Applicant')}"/>
            <g:sortableColumn property="topic" title="${message(code: 'topic.label', default: 'Topic')}"/>
            <g:sortableColumn property="supervisor" title="${message(code: 'application.supervisor', default: 'Supervisor')}"/>
