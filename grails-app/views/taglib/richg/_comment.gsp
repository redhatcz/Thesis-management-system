...
<div class="comment" id="comment-${index}">
    ...
    <div class="dropdown pull-right">
        ...
        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
            ...
            <li><a class="edit-comment" tabindex="-1" href="#">Edit</a></li>
            <%-- this button triggers delete form bellow by javascript (see in richg.js) --%>
            <li><a class="delete-comment" tabindex="-1" href="#">Delete</a></li>
        </ul>
    </div>

    <g:form controller="comment" action="delete" style="display: none;" class="delete-comment-form"
